...
plot(TwoDays$DateTime, TwoDays$Global_active_power, type = 'l', 
     xlab = '', ylab = 'Global Active Power', main = NULL, cex.lab = 0.8, cex.axis = 0.8)
# plot 2
plot(TwoDays$DateTime, TwoDays$Voltage, type = 'l', 
     xlab = 'datetime', ylab = 'Voltage', main = NULL, cex.lab = 0.8, cex.axis = 0.8)
# plot 3
plot(x = TwoDays$DateTime, y = TwoDays$Sub_metering_1, type = 'l', 
     xlab = '', ylab = 'Energy sub metering', main = NULL, cex.lab = 0.8, cex.axis = 0.8)
...
legend('topright', legend = c('Sub_metering_1','Sub_metering_2','Sub_metering_3'), 
       col = c( 'black', 'red', 'blue'), lty = 1, box.lwd = 0, cex = 0.8)
# plot 4
plot(TwoDays$DateTime, TwoDays$Global_reactive_power, type = 'l', 
     xlab = 'datetime', ylab = 'Global_reactive_power', main = NULL, cex.lab = 0.8, cex.axis = 0.8)
